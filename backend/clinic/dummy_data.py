from clinic.models import Patient, Appointment, Treatment, Payment, Diagnostic, Consumable, Tooth
...
def create_dummy_data():
    ...
    dentist, created = CustomUser.objects.get_or_create(
        username="dr.zakaria",
        password="moncef2000",
        first_name="Zakaria",
        last_name="Abdelaidoum",
        email="radiasweetgirl812@gmail.com",
        birth_date="2000-01-05",
        address="12 Rue Mohamed Chabane",
        gender="M",
        role="dentist",
        phone_number="0559879090"
    )

    # Creating the receptionist
    receptionist, created = CustomUser.objects.get_or_create(
        ...
        gender="F",
        role="receptionist",
        phone_number="0664123587"
    )

    # Creating the patient
    mourad, created = Patient.objects.get_or_create(
        first_name="Mourah",
